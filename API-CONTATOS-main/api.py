...
## Meu TOKEN ##
TOKEN = "meu_token_faculdade"

# o decorator se aplica nas rotas protegidas, verifica se o header está presente
...
def token_obrigatorio(f):
    ...
    def decorated(*args, **kwargs):
        ...
        if len(partes) != 2 or partes[0] != "Bearer":
            return jsonify({"erro": "Cabeçalho Authorization inválido "
            "401"}), 401
